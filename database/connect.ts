...
const PraticienModel = require('../models/praticien.model')
...
const BanUserModel = require('../models/banUsers.model.ts')
const CongeModel = require('../models/conge.model')
const Plage_HoraireModel = require('../models/plage_horaire.model')
